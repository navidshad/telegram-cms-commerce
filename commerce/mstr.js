module.exports.commerce = 
{
    ...
    btns: {
        ...
        backsetting: '🔙 بازگشت به ' + '⚙️' + ' - ' + 'تنظیمات تجارت',
    ...
    mess : {
      ...
      gatesNote: '🔄 اگر در حین خرید به هر دلیلی به درگاه پرداخت وارد نشدید بر روی دکمه "دریافت لینک جدید" کلیک کنید، پس از دریافت مجدد همین پست، دوباره وارد درگاه پرداخت شوید تا ایراد رفع گردد.',
    },
    ...
    datas: {
        ...
        tutorialPost: {
            'name'  : 'نام مطلب راهنما',
            'mess'  : 'نام مطلب راهنمای پرداخت را وارد کنید. شما میبایست قبلا این مطلب را در بخش مطالب ایجاد کرده باشید.',
        },
        ...
        // IDPay
        idpayapikey: {
            'name'  : 'کلید api آیدی پی',
            'mess'  : 'لطفا کلید api درگاه آیدی پی را ارسال کنید.',
        },
        getway_idpay: {
            name: 'درگاه آیدی پی',
            mess: 'وضعیت درگاه آیدی پی را مشخص کنید.',
            items : [
                {'name': 'true', 'lable':'فعال'},
                {'name': 'false', 'lable':'غیر فعال'},
            ]
